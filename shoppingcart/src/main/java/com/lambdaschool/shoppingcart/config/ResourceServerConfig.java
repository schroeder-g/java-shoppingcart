...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter
{
     ...
     * @throws Exception in case the configurations fail. */
    @Override
    public void configure(HttpSecurity http) throws  Exception
    {
        ...
        /** The fun part: who can make what requests.
            AntMatchers control which user roles have access to which endpoints.
            Antmatchers necessarily ordered from most restrictive to least restrictive;
            Restrict at method level before restricting at endpoint level.
